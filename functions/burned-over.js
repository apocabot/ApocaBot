...
function moveRoll(userMessage, userId, channelId, userNickname, moves, userData, i){
    ...
    if(moves[i].stat === 'num'){
        if(!input && moves[i]==='sufferHarm'){return 'You must\
 subract harm suffered.\nEXAMPLE: !suffer -1'}
        else if(!input){return 'You must enter your Hx with other character.\nEXAMPLE: !helppc +2'}
        modStat = input
            ...
            if(i.startsWith(value[0])){
                ...
                if(stat){
                    ...
                    if(value[0]==='name'){
                        ...
                        else if(userData[userId][key] === `It's 3 o'clock. That'll heal.`){slashVal = 1}
                        else if(userData[userId][key] === `It's 6 o'clock. Hurt but stable.`){slashVal = 2}
                        else if(userData[userId][key] === `It's 9 o'clock. Serious but stable.`){slashVal = 3}
                        else if(userData[userId][key] === `It's 10 o'clock. You need medical attention.`){slashVal = 4}
                        else if(userData[userId][key] === `It's 11 o'clock. Life-threatening and getting worse.`){slashVal = 5}
                        ...
                        else if (slashVal === 1){userData[userId][key] = `It's 3 o'clock. That'll heal.`}
                        else if (slashVal === 2){userData[userId][key] = `It's 6 o'clock. Hurt but stable.`}
                        else if (slashVal === 3){userData[userId][key] = `It's 9 o'clock. Serious but stable.`}
                        else if (slashVal === 4){userData[userId][key] = `It's 10 o'clock. You need medical attention.`}
                        else if (slashVal === 5){userData[userId][key] = `It's 11 o'clock. Life-threatening and getting worse.`}
                        ...
                        if(slashVal<0){slashVal=0}
                            if(slashVal < 9){
                                userData[userId][key] = `${slashVal} / 9`
                            } else if(slashVal > 8){
                                userData[userId][key] = `${slashVal} / 9 IMPROVE!`
                            }
            ...
            if(i.startsWith(value[0])){
                if(value[0]==="name"){
                    ...
                    if(i>6){i=6}
                        ...
                        else if (i === 1){i = `It's 3 o'clock. That'll heal.`}
                        else if (i === 2){i = `It's 6 o'clock. Hurt but stable.`}
                        else if (i === 3){i = `It's 9 o'clock. Serious but stable.`}
                        else if (i === 4){i = `It's 10 o'clock. You need medical attention.`}
                        else if (i === 5){i = `It's 11 o'clock. Life-threatening and getting worse.`}
...
function newCustomMove(userMessage, userId, channelId, userNickname, moves, userData){
    ...
    const rollRegex = /^[rR][oO][lL][lL]\+"\d+d\d+(\s*|\s\+(aggro|cool|hard|sharp|weird|AGGRO|COOL|HARD|SHARP|WEIRD))$/
